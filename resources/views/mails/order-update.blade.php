                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 0 30px">
                        <div style="padding: 20px 0">
                            <img src="https://res.cloudinary.com/quando213/image/upload/v1632981593/logo_qthnvl.png"
                                 alt="Đi Chợ Hộ" width="150" style="display: block;"/>
                        </div>
                                ...
                                <tr>
                                    <td style="color: #32502E; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                                ...
                                                <li style="margin-top: 15px;">
                                                    ...
                                                    <div style="font-size: 14px;">
                                                        Truy cập <a href="{{ route('makeVNPayPayment', $order->id) }}"
                                                                    style="color: #519e3d; text-decoration: none;">đường dẫn này</a> để thanh toán.
                                                    </div>
                                                </li>
                                            </ol>
                                            @break
                                        ...
                                        <p>Bấm vào nút "Xem đơn hàng" dưới đây để kiểm tra trạng thái đơn hàng của bạn
                                            bất kì lúc nào. Chúng tôi sẽ bắt đầu xử lý đơn hàng sớm nhất có thể, vì vậy
                                            nếu bạn muốn thay đổi thông tin gì, hãy truy cập trang Chi tiết đơn hàng sớm
                                            nhất có thể.</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td style="color: #777777; font-family: Arial, sans-serif; font-size: 12px;">
                                        <p>© {{ env('APP_NAME') ?? 'Quan Do' }}. All rights reserved.</p>
                                    </td>
                                    <td align="right">
                                        <table border="0" cellpadding="0" cellspacing="0"
                                               style="border-collapse: collapse;">
