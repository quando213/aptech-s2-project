                            ...
                            <div class="product-var p-tb-30">
                                <div class="product__stock m-b-20">
                                    <span class="product__stock--in"><i
                                            class="fas fa-check-circle"></i> {{$product->stock}} {{$product->stock > 0 ?"Còn hàng":"Hết Hàng"}}</span>
                                </div>
                                <div class="product__stock m-b-20">
                                    <span
                                        class="product__stock--in">Khối lượng: {{$product->quantity ."  ".\App\Enums\ProductUnit::getDescription($product->unit)}} </span>
                                </div>
                                <div class="product-quantity product-var__item">
                                    <ul class="product-modal-group">
                                        <li><a href="#modalShippinginfo" data-toggle="modal"
                                               class="link--gray link--icon-left"><i class="fal fa-truck-container"></i>Vận
                                                Chuyển</a></li>
                                        <li><a href="#modalProductAsk" data-toggle="modal"
                                               class="link--gray link--icon-left"><i class="fal fa-envelope"></i>Hỏi Đáp
                                                về Sanr Phẩm</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="product-var__item">
                                    <a href="#modalAddCart" id="btnaddtocar" data-toggle="modal" data-dismiss="modal"
                                       class="btn {{$product->stock > 0 ?"":"disabled"}} btn--long btn--radius-tiny btn--green btn--green-hover-black btn--uppercase btn--weight m-r-20">Thêm
                                        Vào Giỏ Hàng</a>
                                </div>
                                <div class="product-var__item">
                                    <div class="dynmiac_checkout--button">
                                        ...
                                        <a href="/cart"
                                           class="btn {{$product->stock > 0 ?"":"disabled"}} btn--block btn--long btn--radius-tiny btn--green btn--green-hover-black text-uppercase m-r-35">Mua
                                            Ngay</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane " id="product-review">
                                            ...
                                            <li class="comment__list">
                                                <div class="comment__wrapper">
                                                    ...
                                                    <div class="comment__content">
                                                        ...
                                                        <div class="para__content">
                                                            <p class="para__text">Sản phẩm okie, giao hàng nhanh dù
                                                                trong mùa dịch, gói hàng kĩ, táo nhìn ngon, ko bị
                                                                dập…</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="comment__list">
                                                <div class="comment__wrapper">
                                                    ...
                                                    <div class="comment__content">
                                                        ...
                                                        <div class="para__content">
                                                            <p class="para__text">Mua 2 lần rồi, táo tươi và giao nhanh
                                                                lắm, cảm ơn shop nhiều. Shop nhiệt tình ạ</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li> <!-- End - Review Comment list-->
                                        ...
                                        <div class="review-form m-t-40">
                                            <div class="section-content">
                                                ...
                                                <p class="section-content__desc">Địa chỉ email của bạn sẽ không được
                                                    công bố. Các trường bắt buộc được đánh dấu *</p>
                                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-content section-content--border m-b-35">
                            ...
                            <a href="/7shop-sidebar-grid-left"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="shipping-info-list m-tb-30">
                                    ...
                                    <li>Purchases are delivered in an orange box tied with a Bolduc ribbon, with the
                                        exception of certain items
                                    </li>
                                    <li>See the delivery FAQs for details on shipping methods, costs and delivery
                                        times
                                    </li>
                                </ul>
                                ...
                                <div class="review-form m-t-30">
                                    ...
                                    <form class="form-box" action="#" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-box__single-group">
                                                    <input type="email" id="modal-ask-email" placeholder="Your email"
                                                           required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-box__single-group">
                                                    <input type="text" id="modal-ask-phone"
                                                           placeholder="Your phone number" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-box__single-group">
                                                    <textarea id="modal-ask-message" rows="8"
