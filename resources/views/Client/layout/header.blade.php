                                            ...
                                            <li class="mega-menu__box">
                                                ...
                                                <div class="mega-menu__item-box">
                                                    ...
                                                    <ul class="mega-menu__item">
                                                        ...
                                                        {{--                                                            <a href="/shop-layout/shop-sidebar-grid-left" class="mega-menu__link">Grid Right Sidebar</a>--}}
                                                        {{--                                                            <span class="menu-label menu-label--red">New</span>--}}
                                                        {{--                                                        </li>--}}
                                                ...
                                                <div class="mega-menu__item-box">
                                                    ...
                                                    <ul class="mega-menu__item">
                                                        ...
                                                        <li class="mega-menu__list pos-relative">
                                                            <a href="/emply-cart" class="mega-menu__link">Empty Cart</a>
                                                ...
                                                <div class="mega-menu__item-box">
                                                    ...
                                                    <ul class="mega-menu__item">
                                                        <li class="mega-menu__list"><a href="/product-single-default" class="mega-menu__link">Simple</a></li>
                                                        ...
                                                        <li class="mega-menu__list"><a href="/product-single-tab-left" class="mega-menu__link">Left Tab</a></li>
                                        ...
                                        <ul class="dropdown__menu pos-absolute">
                                            ...
                                            {{--                                            </li>--}}
                                                                                        <li class="dropdown__list">
                                                                                            ...
                                                                                            <ul class="dropdown__submenu pos-absolute">
                                                                                                <li class="dropdown__submenu-list"><a href="/blog-list-sidebar-left" class="dropdown__submenu-link"> Blog List Left Sidebar</a></li>
{{--                                                                                                <li class="dropdown__submenu-list"><a href="blog-list-sidebar-right.html" class="dropdown__submenu-link"> Blog List Right Sidebar</a></li>--}}
                                            ...
                                            <li class="dropdown__list">
                                                ...
                                                <ul class="dropdown__submenu pos-absolute">
                                                    <li class="dropdown__submenu-list"><a href="/blog-simple-sidebar-left" class="dropdown__submenu-link"> Blog Single Left Sidebar</a></li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="/emply-cart">Empty Cart</a></li>
                                    {{--                                    <li><a href="wishlist.html">Wishlist</a></li>--}}
                                    <li><a href="/my-accoun">My Account</a></li>
                                    <li><a href="/loginl">Login</a></li>
    ...
    <div  id="offcanvas-add-cart__box" class="offcanvas offcanvas-cart offcanvas-add-cart">
        ...
        <ul class="offcanvas-add-cart__menu">
            ...
            <li class="offcanvas-add-cart__list pos-relative d-flex align-items-center justify-content-between ">
                <div class="offcanvas-add-cart__content d-flex align-items-start m-r-10">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="/product-single-default" class="offcanvas-add-cart__img-link img-responsive"><img src="assets/img/product/size-small/product-home-1-img-1.jpg" alt="" class="add-cart__img"></a>
            ...
            <li class="offcanvas-add-cart__list pos-relative d-flex align-items-center justify-content-between">
                <div class="offcanvas-add-cart__content d-flex  align-items-start m-r-10">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="/product-single-default" class="offcanvas-add-cart__img-link img-responsive"><img src="assets/img/product/size-small/product-home-1-img-2.jpg" alt="" class="add-cart__img"></a>
                        <span class="offcanvas-add-cart__item-count pos-absolute">2x</span>
                    </div>
                    <div class="offcanvas-add-cart__detail">
                        <a href="/product-single-default" class="offcanvas-add-cart__link">Lucky Wooden Elephant</a>
        ...
        <div class="offcanvas-add-cart__checkout-box-bottom">
            ...
            <div class="offcanvas-add-cart__btn-checkout">
                <a href="/checkout" class="btn btn--block btn--radius btn--box btn--black btn--black-hover-green btn--large btn--uppercase font--bold">Checkout</a>
            </div>
