            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">CHi Tiết Gói Sản Phẩm</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="product-gallery-box product-gallery-box--default m-b-60">
                            <div class="product-image--large product-image--large-horizontal">
                                <img class="img-fluid" id="img-zoom" src="{{$data->thumbnail}}" data-zoom-image="{{$data->thumbnail}}" alt="">
                            </div>
                    ...
                    <div class="col-md-7">
                        <div class="product-details-box m-b-60">
                            <h4 class="font--regular m-b-20">{{$data->name}}</h4>
                            ...
                            <div class="product__price m-t-5">
                                <span class="product__price product__price--large">Giảm giá</span>
                            ...
                            <div class="product-var p-tb-30">
                                <div class="product__stock m-b-20">
                                    <span class="product__stock--in"><i class="fas fa-check-circle"></i>Hàng có trong kho: 1000</span>
                                </div>
                                <div class="product-quantity product-var__item">
                                    <ul class="product-modal-group">
                                        ...
                                        <li><a href="#modalProductAsk" data-toggle="modal"  class="link--gray link--icon-left"><i class="fal fa-envelope"></i>Hỏi Đáp về Sản Phẩm</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show active" id="product-desc">
                                        <div class="para__content">
                                            <p class="para__text">{{$data -> description}}</p>
                                        ...
                                        <div class="product-dis__content">
                                            ...
                                            <div class="table-responsive-md">
                                                <table class="product-dis__list table table-bordered">
                                                    <tbody>
                                                    <tr>
                                                        <td class="product-dis__title">Khối lượng</td>
                                                        <td class="product-dis__text">{{$data -> quantity}}</td>
                                                    </tr>
                                                    {{--                                                    <tr>--}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="product-dis__text">{{$data -> brand}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="product-dis__title">Nguồn ngốc xuất sứ</td>
                                                        <td class="product-dis__text">{{$data -> origin}}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
