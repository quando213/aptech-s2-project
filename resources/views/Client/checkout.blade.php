                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-box__single-group">
                                    ...
                                    <input type="text" name="shipping_name" value="{{$data ? $data->first_name .' '.$data->last_name :''}}" id="form-first-name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-box__single-group">
                                    ...
                                    <input type="text" name="shipping_street" id="form-address-1" value="{{$data->street}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-box__single-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-box__single-group">
                                    ...
                                    <textarea name="node"  id="form-additional-info" rows="5" placeholder="Ghi Chú."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="your-order-product-info">
                                ...
                                <ul class="your-order-middle">
                                    ...
                                    <li class="d-flex justify-content-between">
                                        ...
                                        <span class="your-order-middle-right font--semi-bold">{{$item->subtotal(0)}}</span>
                                    </li>
                                    @endforeach
...
{{--                                </div>--}}
                        ...
                        <div class="text-center">
                            <button class="btn btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--bold" id="btn" type="submit">Đặt Hàng</button>
                        </div>
                    </div>
