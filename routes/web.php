...
Route::get('/categories/formCategori', [TemplateAdminController::class, 'formCategory']);
Route::get('/categories/listCategori', [TemplateAdminController::class, 'listCategory']);
